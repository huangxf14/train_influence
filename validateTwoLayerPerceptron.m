function [correctlyClassified, classificationErrors, error] = validateTwoLayerPerceptron(activationFunction, hiddenWeights, outputWeights, inputValues,labels)
...
% 
    ...
    for n = 1: testSetSize
        ...
        gt = zeros(size(outputVector-1,1),1);
        gt(labels(n)+1)=1;
        error = error + norm(outputVector-gt,2);
